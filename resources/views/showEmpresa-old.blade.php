            ...
            <div class="table-responsive">
                <div class="table-wrapper">
                    <div class="table-title">
                        <div class="row">
                            <div class="col-xs-6">
                                <h2>Cadastro de <b>Empresas</b></h2>
                            </div>
                            <div class="col-xs-6">
                                <a href="#addEmployeeModal" class="btn btn-success" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Adicionar nova Empresa</span></a>
                        ...
                        <tbody>
                           @foreach ($partners as $partner )
                            <tr>
                                ...
                                -->
                                <td>
                                    <a href="#editEmpresaModal" class="edit" data-toggle="modal"><i class="material-icons"
                    ...
                    <form name="formCad" id="formCad" method="POST" action="{{url('/parceiros/create')}}">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" required type="text" name="CodFiscal" id="CodFiscal" /><br>
                            </div>
                            <div class="form-group">
